---
title: "Cell trajectory of hematopoiesis with Totem"
...
# Download data sets
url2down <- "https://zenodo.org/record/1443566/files/real/silver/hematopoiesis-clusters_olsson.rds?download=1"
download.file(url = url2down, destfile = "../data/hematopoiesis-clusters_olsson.rds")

# Import data sets
dyn <- readRDS(file = "../data/hematopoiesis-clusters_olsson.rds")
```

The R object downloaded (file extension `.rds`), `hematopoiesis-clusters_olsson.rds`,  was saved in the folder `data` and imported and saved into R with the object name `dyn`. 
...
The highest values of cell connectivity were for cluster 3. Therefore, let's pick the cluster 4 as the root. 
